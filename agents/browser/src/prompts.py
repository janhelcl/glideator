...
retrieval_instructions = Template("""You are an Agent that is given skilled in web searching and knowledgeable about paragliding. Your goal is to search the web and try to find websites related to the paragliding site you are given.
Instructions:

...
class CandidateWebsiteEvidence(BaseModel):
    takeoff_landing_areas: bool = Field(description="Whether the website provides information about takeoff and landing areas")
    rules: bool = Field(description="Whether the website provides information about specific local rules and regulations")
    ...
    meteostation: bool = Field(description="Whether the website provides information about local meteostation")
...
class RetrievalResult(BaseModel):
    candidate_websites: List[CandidateWebsite] = Field(description="List of candidate websites that are relevant to the research site")
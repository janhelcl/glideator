...
- [0010 — Do not replace the main XC model with TabPFN-3](0010-xc-reject-tabpfn3-as-main-model.md)
...
- [0016 — Do not use Jev 1.13 as the main XC model](0016-xc-reject-jev-1-13.md)
